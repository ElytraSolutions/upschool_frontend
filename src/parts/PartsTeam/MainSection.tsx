import Banner from '../../assets/Team/banner.webp';
import door from '../../assets/Team/door.png';
    ...
    return (
        <div className="h-[95vh] w-[100%] overflow-hidden">
            ...
            <div className="h-[95vh] w-[100%] flex flex-col justify-center items-center gap-1">
                ...
                {/* door */}
                <img className="h-[50vh] w-auto z-10" src={door} alt="door" />
                {/* subetext */}
                <h3 className="text-xl text-white leading-8 tracking-wide text-center md:w-[60%]">
