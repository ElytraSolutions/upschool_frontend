                ...
                <a
                    className={`${
                        chapter.canva_template
                            ? 'flex gap-4 items-center justify-center'
                            : 'hidden'
                    } max-w-fit h-fit bg-theme-color text-white px-[20px] py-[8px] text-[14px] text-center cursor-pointer`}
                ...
                <button
                    className={`${
                        chapter.canva_template
                            ? 'flex gap-4 items-center justify-center'
                            : 'hidden'
                    } max-w-fit h-fit bg-red-custom text-white px-[20px] py-[8px] text-[14px] text-center`}
                    onClick={() => {
