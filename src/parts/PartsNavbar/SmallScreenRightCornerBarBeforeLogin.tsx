...
const SmallScreenRightCornerBarBeforeLogin = () => {
    return (
        <span className="group/bar w-9 h-9">
            ...
            <ul className="bg-white text-black rounded-md transform scale-0 group-hover/bar:scale-100 absolute transition duration-150 ease-in-out origin-top -translate-x-7 overflow-hidden">
                <li className="hover:bg-red-upschool  hover:text-white px-6 py-3">
