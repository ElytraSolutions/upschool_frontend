...
export function UploadBookStep2({
    ...
    return (
        <div className="flex justify-center pt-10 pb-5 text-font-color  h-full xm:h-[565px] w-full">
            <div className="flex flex-col gap-9  w-11/12">
                                    ...
                                    <div className="flex flex-col gap-1 md:gap-3 items-start mt-5 text-sm tab:text-sm ">
                                        ...
                                        <div className="flex flex-row justify-start items-center gap-4">
                                            ...
                                            <span className="font-light">
                                                My book has a blank page after
                                                the front cover and another
                                        ...
                                        <div className="flex flex-row justify-start items-center gap-4">
                                            ...
                                            <span className="font-light">
                                                The total number of pages in my
                                                book is an even number.(12, 14,
                                                16, 18, 20, ...)
                                            </span>
                                        </div>
                                        {/* Third option */}
                                        <div className="flex flex-row justify-start items-center gap-4">
                                            ...
                                            <span className="font-light">
                                                My text is in the Safe Zone and
                                                not near the edges of the page.
                                            </span>
                                        </div>
                                        {/* Fourth option */}
                                        <div className="flex flex-row justify-start items-center gap-4">
