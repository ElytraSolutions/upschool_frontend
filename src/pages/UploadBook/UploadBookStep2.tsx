                ...
                {({
                    ...
                    <>
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-1 items-start mt-5 text-xs tab:text-sm ">
                                ...
                                <div className="flex flex-row justify-start items-center gap-4">
                                    <div className=" border border-gray-400 w-8 h-8 rounded-full flex justify-center items-start">
                                        <span className="mt-1">
                                            <svg
                                    ...
                                    <span className="font-light">
                                        My book has a blank page after the front
                                        cover and another before the back cover.
                                    </span>
                                </div>
                                {/* Second option */}
                                <div className="flex flex-row justify-start items-center gap-4">
                                    ...
                                    <span className="font-light">
                                        The total number of pages in my book is
                                        an even number.(12, 14, 16, 18, 20, ...)
                                    </span>
                                </div>
                                {/* Third option */}
                                <div className="flex flex-row justify-start items-center gap-4">
                                    ...
                                    <span className="font-light">
                                        My text is in the Safe Zone and not near
