...
export default function BookUpdated({
    ...
    return (
        <>
            <div className="flex justify-center items-center p-3 md:p-5 bg-gray-200 h-full  w-full text-font-color font-medium lg:font-semibold ">
                <div className="flex flex-col items-start h-fit w-[95vw] md:w-[80vw] tab:w-[70vw] py-2">
                    <div className="bg-white p-6 md:p-10 lg:p-14  w-full flex flex-col items-start gap-3 md:gap-6 mt-4">
                        <div className="">
                    ...
                    <div className="flex  flex-col m-3  xs:mx-3 xs:my-6   xs:flex-row xs:justify-around  md:justify-evenly w-10/12 xs:w-full">
                        ...
                        <NavLink to="." className="my-1 xs:my-0 ">
                            <div
                                className="bg-red-upschool text-white  py-2 px-4 sm:py-4 sm:px-8"
                                onClick={() => {
                                    setIsUploadBookCompleted(false);
