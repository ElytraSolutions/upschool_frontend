...
function CourseDetail() {
  ...
  const course: ICourse = {
    ...
    image:
      "https://upschool.co/wp-content/uploads/2023/05/Power-of-One-Featured-Image-853x1024.png",
  ...
  return (
    ...
    <div className="flex flex-col gap-10 ">
      <div className="bg-cover" style={{ backgroundImage: `url('/images/ack/back.jpg')` }} >
      <div  className="bg-[#242254c0] px-10 py-2">
      <div className="max-w-6xl m-auto" >
        <div className="flex flex-col md:flex-row">
          <div className="flex flex-col gap-5 py-10 md:px-10">
            <div className="text-3xl" style={{ color: course.theme }}>
              This tagline
            </div>
            <div className="text-5xl font-bold" style={{ color: course.theme }}>{course.name}</div>
            <div className="sm:text-xl md:text-[20px] text-white">{course.intro}</div>
            <div style={{ color: course.theme }}>* {course.starredText}</div>
            <div className="flex flex-col  flex-start gap-6">
              <a style={{backgroundColor: !isHovered ? course.theme : '#ca7491'}} 
              ...
              <p className="font-semibold text-white">Register for a FREE Upschool account to enrol in this course.</p>
            </div>
          </div>
