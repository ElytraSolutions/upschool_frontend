...
const Login = () => {
    //This handles to show the social login buttons or not
    ...
    return (
        <>
            <div className="grid">
                <Navbar />
                <div className="flex items-center justify-center bg-gray-200 h-[calc(100vh-4rem)]">
                    <div className="relative flex flex-row justify-center  bg-gray-200 h-fit py-4 px-1 md:py-8 2xl:py-16 xlarge:p-20 xxlarge:p-24 ">
                        <div className="w-[95%] sm:w-[80vw] tab:w-[45vw] xlarge:w-[600px] bg-white flex justify-center items-center min-h-[500px] py-4 shadow-[0px_5px_10px_6px_rgba(0,0,0,0.1)]">
                            <div className="w-11/12 py-3">
                                <div className="  mt-0.5 md:mt-2">
                                    ...
                                    {showSocialLogin && (
                                        <div className=" grid grid-cols-4 gap-y-2 gap-x-4 px-2 mx-2 my-1 w-full mt-2">
                                            <button
                                                type="button"
                                                className={`${
                                                    isLargeScreen
