        ...
        <div className="pt-[40px]">
          <div className="flex flex-col items-center">
            ...
            <p className="mb-[1rem] text-[18px] leading-9 text-center max-w-4xl text-[#242254] ">
              ...
              emphasising the importance of intention-based learning. The
              framework is designed to foster purpose-driven education that
              equips students with the skills, knowledge and values to tackle
              global challenges and create positive social, environmental and
              economic impacts.
            </p>
          </div>
