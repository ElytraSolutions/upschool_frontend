        ...
        <div className="h-full overflow-auto">
            <div className="p-2 md:py-4 md:px-4 xlarge:px-6 xxlarge:px-8 w-full">
                <div className="flex flex-col gap-10 w-full">
                    ...
                    {/* Detail section */}
                    <div className="w-full xxxl:max-w-[1600px] 1520:max-w-[1300px]  max-w-[1000px]">
                        {/* Enrolled courses section */}
                        {selectedOption === 'Enrolled Courses' && (
                            <div className="grid xm:grid-cols-2 md:grid-cols-2 xl:grid-cols-3  xxxl:grid-cols-4  justify-items-center md:justify-items-start gap-6 md:gap-2 lg:gap-4 w-full">
