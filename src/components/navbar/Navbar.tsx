...
export default function Navbar() {
    ...
    return (
        <>
            <div className="bg-theme-color p-1 md:py-7 md:px-2">
                <div className="flex gap-2 md:gap-3 items-center lg:gap-10 justify-between" >
                    ...
                    <div className="flex gap-1 lg:gap-2 2xl:gap-3 justify-end">
                        <span className="h-8 w-8"><ShoppingCartIcon className="text-white" /></span>
                        <span className="h-8 w-8"><UserCircleIcon className="text-white" /></span>
