...
function footer() {
  return (
    <>
    <div className='bg-cover  bottom-0 '  style={{backgroundImage:`url('/images/footerbackground.jpg')`}}>
        <div className="bg-[#181739F0] flex justify-center">
            <div className="container max-w-7xl">
                <div className="flex justify-center">
                    <div className="">
                        <img src={footerboy} className='w-[500px] md:w-[250px] pt-10' alt=""/>
                    </div>
                </div>
                <div className="row justify-center">
                    <div className="flex flex-col text-[#fff] items-center">
                        ...
                        <div className=" flex justify-center w-[50vw] md:w-[30vw] ">
                            <img src={footerbackground} className="w-[300px] " alt=""/>
                        </div>
                        <h5 className='font-bold text-xs p-4 tracking-widest'>Acknowledgement of Country</h5>
                        <p className="text-[12px] tracking-wide max-w-2xl font-light text-center md:max-w-3xl lg:max-w-4xl p-2 leading-5 pb-6">Upschool would like to acknowledge that we live, work, learn and play on
                            the
                ...
                <div className="flex flex-col md:flex-row items-center justify-between p-4">
                    ...
                    <div className="col-md-6">
                        <div className="mt-2 md:mt-0 flex flex-wrap  justify-center gap-6 ">
                            <a href="#" className="text-white text-[12px] font-light">Navigating the Platform</a>
                            <a href="#" className="text-white text-[12px] font-light">Disclaimer</a>
                            <a href="#" className="text-white text-[12px] font-light">Terms of Use</a>
                            <a href="#" className="text-white text-[12px] font-light">Privacy Policy</a>
                            <a href="#" className="text-white text-[12px] font-light">Contact Us</a>
